        ...
        <div class="col-lg-12 m-auto col-sm-12 col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center">View Resigned Employee</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><b>Status:
                                        ...
                                        class="bg-danger p-1 text-white">{{ $employee->status == 0 ? 'Resigned' : 'Active' }}</span>
                                </li>
                        ...
                        <div class="col-lg-6">
                            <ul class="list-group">
                                ...
                                @php
                                    ...
                                    $resignedDate = new DateTime($employee->resigned_date);
                                @endphp
                                ...
                                <li class="list-group-item"><b>Resigned Date:
                                    </b> {{ $resignedDate->format('d-m-Y') }}
                                </li>
