                    ...
                    <div class="d-flex align-items-center gap-lg-2 gap-1">
                        ...
                        <div class="app-search dropdown d-none d-lg-block">
                            ...
                            <div class="input-group">
                                    <input type="search" name="query" class="form-control dropdown-toggle" placeholder="Search..." id="top-search">
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> © Ixony - ixony.com
                            </div>
                        </div>
                    </div>
                </footer>
