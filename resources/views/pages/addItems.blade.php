...
<div class="col-xl-7 col-lg-6">
    ...
    <div class="card card-h-100">
        ...
        <form class="col" method="POST" action="{{route('addItemToStock', $stockBundle->id)}}">
        @csrf
        ...
        <div class="col-auto mt-3">
            <input type="text" class="form-control" placeholder="Units" name="units"  value="">
        </div>
        <div class="col-auto mt-3">
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap table-hover mb-0">
                        ...
                        <tr>
                                ...
                                <td>
                                    <a href="{{route('deleteItemFromStock', $item->id)}}"  class="btn btn-sm">Delete</a>
                                </td>
