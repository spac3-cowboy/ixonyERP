...
@section('content')
<div class="row">
                            <div class="col-xl-12 col-lg-6 order-lg-2 order-xl-1 border border-info rounded">
                                <div class="card">
                                    <div class="d-flex card-header justify-content-between align-items-center">
                                        <h4 class="header-title">Stock In Details</h4>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('stockInItems', $item->id)}}"  class="btn btn-sm">Add Product</a>
                                                        </td>
