    ...
    <div class="col-sm-6">
        <div class="card widget-flat">
            <div class="card-body">
                ...
                <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Products</h5>
                <h3 class="mt-3 mb-3">{{$totalProduct-$challanProduct}}</h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
    ...
    <div class="col-sm-6">
        <div class="card widget-flat">
            <div class="card-body">
                ...
                <h3 class="mt-3 mb-3">{{$totalUser}}</h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
</div> <!-- end row -->
    ...
    <div class="col-sm-6">
        <div class="card widget-flat">
            <div class="card-body">
                ...
                <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Total Stock In</h5>
                <h3 class="mt-3 mb-3">{{$totalStockIn}}</h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
    ...
    <div class="col-sm-6">
        <div class="card widget-flat">
            <div class="card-body">
                ...
                <h5 class="text-muted fw-normal mt-0" title="Growth">Total Stock Out</h5>
                <h3 class="mt-3 mb-3">{{$totalStockOut}}</h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
</div> <!-- end row -->
        ...
        <table class="table table-centered table-nowrap table-hover mb-0">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <h5 class="font-14 my-1 fw-normal">{{$item->model}}</h5>
                        <span class="text-muted font-13">Model</span>
                    </td>
                    <td>
                        <h5 class="font-14 my-1 fw-normal">{{$item->current_price}}</h5>
                        <span class="text-muted font-13">price</span>
                    </td>
                    <td>
                        <h5 class="font-14 my-1 fw-normal">{{$item->current_stock}}</h5>
                        <span class="text-muted font-13">Stock</span>
                    </td>
                </tr>
                ...
                @endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <h4>Create User</h4>
                                <div class="card">
                                    <form class="col" method="POST" action="{{route('createUser')}}">
                                        @csrf
                                        <div class="col-auto">
                                            <input type="text" class="form-control border border-primary text-primary" placeholder="Name" name="name">
                                        </div>
                                        <br/>
                                        <div class="col-auto">
                                            
                                            <input type="text" class="form-control border border-primary text-primary" placeholder="Email" name="email">
                                        </div>
    
                                        <div class="col-auto mt-3">
                                            
                                            <input type="text" class="form-control border border-primary text-primary" placeholder="Password" name="password">
                                        </div>

                                        
                                        <div class="col-auto mt-3">
                                            
                                            <input type="text" class="form-control border border-primary text-primary" placeholder="Role" name="role_id">
                                        </div>
